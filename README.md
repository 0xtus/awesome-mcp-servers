...
- <img src="https://azeth.ai/images/logo-nobg.svg" alt="Azeth Logo" height="14"/> [Azeth](https://github.com/azeth-protocol/mcp-server) - Trust infrastructure for the machine economy — non-custodial ERC-4337 smart accounts, x402 payments, on-chain reputation via ERC-8004, and service discovery for AI agents.
